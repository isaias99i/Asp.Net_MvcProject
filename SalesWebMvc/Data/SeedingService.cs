...

{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Lara Silva", "lara@gmail.com", new DateTime(1978, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria Green", "green@gmail.com", new DateTime(1979, 12, 31), 3500.0, d2);
            Seller s3 = new Seller(3, "Martha Souza", "souza@gmail.com", new DateTime(1999, 9, 1), 2200.0, d1);
            Seller s4 = new Seller(4, "Daisy Johnson", "johnson@gmail.com", new DateTime(2000, 8, 25), 3000.0, d4);
            Seller s5 = new Seller(5, "Donald Duck", "duck@gmail.com", new DateTime(1998, 11, 3), 4000.0, d3);
            Seller s6 = new Seller(6, "Alek Dick", "dick@gmail.com", new DateTime(1997, 5, 22), 3000.0, d2);
